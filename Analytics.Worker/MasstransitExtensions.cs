...
public static class MasstransitExtensions
{
    public static void AddMasstransit(this HostApplicationBuilder builder)
    {
        ...
        {
            x.AddConsumer<DeviceAuthFailedConsumer>();
            x.AddConsumer<DeviceAuthenticatedConsumer>();
            x.AddConsumer<DeviceDisposedConsumer>();
            x.AddConsumer<ConnectionCountUpdatedConsumer>();
